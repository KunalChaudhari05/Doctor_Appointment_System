...
public class AppointmentSystem {
    ...
    public static void main(String[] args) {
        ...
        Doctor doctor1 = new Doctor(1, "Dr. Sarode", 3);
        Doctor doctor2 = new Doctor(2, "Dr. Shukla", 4);
        ...
        // Book an appointment
        boolean appointmentBooked = appointmentSystem.bookAppointment(1, "2023-03-10", "12:00");
